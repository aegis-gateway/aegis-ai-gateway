...
CREATE UNIQUE INDEX IF NOT EXISTS idx_audit_checkpoints_range
    ON audit_checkpoints (range_start, range_end);
CREATE INDEX IF NOT EXISTS idx_audit_checkpoints_prev
    ON audit_checkpoints (prev_checkpoint_id);
